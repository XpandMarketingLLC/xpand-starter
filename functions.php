...
/*
 * Define constants
 * Make it easier to access regularly used directories
 */
...
function starter_scripts() {
	...
	// html5shiv for IE8
	wp_enqueue_script( 'respond', TEMPLATE . '/assets/js/ie/respond.min.js', array(), '1.4.2', false);
	wp_script_add_data( 'respond', 'conditional', 'lt IE 8' );
	
	// Respond.js for IE8 media query support
	wp_enqueue_script( 'html5shiv', TEMPLATE . '/assets/js/ie/html5shiv.js', array(), '3.7.3', false);
	wp_script_add_data( 'html5shiv', 'conditional', 'lt IE 8' );
	
	// load bootstrap css
	wp_enqueue_style( 'bootstrap', TEMPLATE . '/assets/css/bootstrap.min.css', array(), NULL );
	...
	wp_register_script('bootstrap-script', TEMPLATE . '/assets/js/bootstrap.min.js', array('jquery'), '3.3.5', true);
